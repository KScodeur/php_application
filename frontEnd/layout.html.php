...
<head>
  ...
  <title>Myschool - <?=$pageTitle?></title>
  ...
  <link href="frontEnd/assets/css/own.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="../Niceadmin/dashboard.php" class="logo d-flex align-items-center">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../Niceadmin/dashboard.php">
          <i class="bi bi-grid"></i>
          <span>Dashboard</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="../Niceadmin/eleves.php">
          <i class="bi bi-grid"></i>
          <span>Elèves</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="../Niceadmin/scolarite.php">
          <i class="bi bi-grid"></i>
          <span>Scolarité / classe</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="../Niceadmin/matiere.php">
          <i class="bi bi-grid"></i>
          <span>Matières</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="../Niceadmin/professeur.php">
          <i class="bi bi-grid"></i>
  ...
  <script src="frontEnd/assets/vendor/chart.js/chart.min.js"></script>
